...
def get_date_range(start_months_ago=3, end_on_last_day=False, reference_date=None):
    """
    ...
    Args:
        months_ago (int): How many months ago to set the start date. Default is 3.
    ...
    Returns:
        tuple: (start_label, end_label, start_date_gee, end_date_gee)
    """
    ...
    # Start date: first day of `months_ago` months ago
    start_date = this_month_first - relativedelta(months=startmonths_ago)

    # End date: first or last day of the prior month
    if end_on_last_day:
        prior_month_first = this_month_first - relativedelta(months=1)
